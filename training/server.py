...
def run_proxy_Server():
    ...
    print(f'Stating Proxy Server at {server_port}')

    subprocess.run(["mitmdump", "--listen-host", "127.0.0.1", "--listen-port", str(server_port), "-s", "forward.py"])
    print("Proxy server started from thread")
